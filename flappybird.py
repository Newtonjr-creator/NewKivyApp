...
background_img = pygame.image.load('gallery/sprites/background.png')
...
heart_img = pygame.image.load('gallery/sprites/heart.png').convert_alpha()
heart_img = pygame.transform.scale(heart_img, (50, 50))
message_img = pygame.image.load('gallery/sprites/message.png').convert_alpha()
message_img = pygame.transform.scale(message_img, (SCREEN_WIDTH, SCREEN_HEIGHT))
game_over_img = pygame.image.load('gallery/sprites/game_over.png').convert_alpha()

# Load sound effects
jump_sound = pygame.mixer.Sound('gallery/audio/wing.wav')
...
heart_sound = pygame.mixer.Sound('gallery/audio/heart.wav')  # Add a sound for the heart

# Load number sprites for the score
numbers = [pygame.image.load(f'gallery/sprites/{i}.png').convert_alpha() for i in range(10)]
